...
public class DisplayStylePredictor {
  private static DisplayStylePredictor instance = null;
  ...
  private DisplayStylePredictor() {
    InputStream in = null;
    BufferedReader reader = null;
    try {
      in = getClass().getResourceAsStream("/display_style_model.v1/model.tsv");
      ...
      in = getClass().getResourceAsStream("/display_style_model.v1/feature.tsv");
      reader = new BufferedReader(new InputStreamReader(in));
      while ((line = reader.readLine()) != null) {
        String[] tokens = line.split("\t");
  ...
  public static DisplayStylePredictor getInstance() {
    if (instance == null)
      synchronized (DisplayStylePredictor.class) {
        if (instance == null)
          instance = new DisplayStylePredictor(); 
      }  
    return instance;
  }
